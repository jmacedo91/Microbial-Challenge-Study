...
entry_time0 = Entry(frame_left, width=10, justify='center', relief='solid')
entry_time0.place(x=15, y=30)
entry_time0.insert(0, "T0")

entry_time1 = Entry(frame_left, width=10, justify='center', relief='solid')
entry_time1.place(x=15, y=55)
entry_time1.insert(0, "T1")

entry_time2 = Entry(frame_left, width=10, justify='center', relief='solid')
entry_time2.place(x=15, y=80)
entry_time2.insert(0, "T2")

entry_time3 = Entry(frame_left, width=10, justify='center', relief='solid')
entry_time3.place(x=15, y=105)
entry_time3.insert(0, "T3")

entry_time4 = Entry(frame_left, width=10, justify='center', relief='solid')
entry_time4.place(x=15, y=130)
entry_time4.insert(0, "T7")

entry_time5 = Entry(frame_left, width=10, justify='center', relief='solid')
entry_time5.place(x=15, y=155)
entry_time5.insert(0, "T14")

entry_time6 = Entry(frame_left, width=10, justify='center', relief='solid')
entry_time6.place(x=15, y=180)
entry_time6.insert(0, "T21")

entry_time7 = Entry(frame_left, width=10, justify='center', relief='solid')
...
entry_date0 = DateEntry(frame_left, date_pattern='dd/mm/yyyy', width=10, background='darkblue', foreground='white',
                        borderwidth=2)
entry_date0.place(x=80, y=30)

entry_date1 = DateEntry(frame_left, date_pattern='dd/mm/yyyy', width=10, background='darkblue', foreground='white',
                        borderwidth=2)
entry_date1.place(x=80, y=55)

entry_date2 = DateEntry(frame_left, date_pattern='dd/mm/yyyy', width=10, background='darkblue', foreground='white',
                        borderwidth=2)
entry_date2.place(x=80, y=80)

entry_date3 = DateEntry(frame_left, date_pattern='dd/mm/yyyy', width=10, background='darkblue', foreground='white',
                        borderwidth=2)
entry_date3.place(x=80, y=105)

entry_date4 = DateEntry(frame_left, date_pattern='dd/mm/yyyy', width=10, background='darkblue', foreground='white',
                        borderwidth=2)
entry_date4.place(x=80, y=130)

entry_date5 = DateEntry(frame_left, date_pattern='dd/mm/yyyy', width=10, background='darkblue', foreground='white',
                        borderwidth=2)
entry_date5.place(x=80, y=155)

entry_date6 = DateEntry(frame_left, date_pattern='dd/mm/yyyy', width=10, background='darkblue', foreground='white',
                        borderwidth=2)
entry_date6.place(x=80, y=180)

entry_date7 = DateEntry(frame_left, date_pattern='dd/mm/yyyy', width=10, background='darkblue', foreground='white',
                        borderwidth=2)
...
label_date = Label(frame_left, text='Contagem *', anchor=NW, font='Ivy 10 bold', bg="#feffff", fg="#403d3d",
                   relief='flat')
label_date.place(x=164, y=10)

entry_count0 = Entry(frame_left, width=15, justify='left', relief='solid')
entry_count0.place(x=164, y=30)

entry_count1 = Entry(frame_left, width=15, justify='left', relief='solid')
entry_count1.place(x=164, y=55)

entry_count2 = Entry(frame_left, width=15, justify='left', relief='solid')
entry_count2.place(x=164, y=80)

entry_count3 = Entry(frame_left, width=15, justify='left', relief='solid')
entry_count3.place(x=164, y=105)

entry_count4 = Entry(frame_left, width=15, justify='left', relief='solid')
entry_count4.place(x=164, y=130)

entry_count5 = Entry(frame_left, width=15, justify='left', relief='solid')
entry_count5.place(x=164, y=155)

entry_count6 = Entry(frame_left, width=15, justify='left', relief='solid')
entry_count6.place(x=164, y=180)

entry_count7 = Entry(frame_left, width=15, justify='left', relief='solid')
entry_count7.place(x=164, y=205)
    ...
    for row in range(8):
        ...
        if entry_count[row].get() == '':
            ...
            if row == 0:
                ...
                reduction = 100 * (1 - (1 / (10 ** (np.log10(float(entry_count[row - 1].get().replace(",", ".")) / contagem)))))
...
insert_button = Button(frame_left, text="Inserir Dados", width=20, font="Ivy 9 bold", fg="black", relief='raised',
                       overrelief='ridge', command=insert)
